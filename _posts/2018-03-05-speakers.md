...
<a name="cees"></a>
{% include speaker-card.html avatarurl="cees.png" profilename="Cees Hof, PhD"  affiliation="Department of Biomedical Engineering and Physics,<br>Data Archiving and Networked Services (DANS), KNAW,<br>The Hague, The Netherlands" homepage="https://dans.knaw.nl/en"%}
